...
- Cursor controls aim
- Click the matching color zone when the ball is near it to score
- Score counter, miss counter, streak tracking
...
- Crowd noise and visual energy as streak builds
